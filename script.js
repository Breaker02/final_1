(function(){
    ...
    const txtArr = ['Web Publisher', 'Front-End Developer', 'Web Ul Desiger', 'UX Designer', 'Back-End Developer'];
    let index = 0;
    ...
    function deleteTxt(){
        ...
        if(currentTxt.length !== 0){
            setTimeout(deleteTxt, Math.floor(Math.random()*250));
        }else{
...
function scrollCheck(){
    ...
    if(browerScrollY > 0){headerEl.classList.add("active");}
